 ...
 *
 */
class PasswordRepeat extends Abstract\Field {
     ...
     * @param int|null $show_btn
     * @return self
     */
    public function setShowBtn(int $show_btn = null): self {
     ...
     * @return string|null
     */
    public function getShowBtn():? string {
    ...
    public function toArray(): array {
        ...
        if ( ! is_null($this->show_btn)) {
            $result['showBtn'] = $this->show_btn;
        }
